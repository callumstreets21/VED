...
#include "ProfilingToolsPlusInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UProfilingToolsPlusInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UProfilingToolsPlusInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UProfilingToolsPlusInteractiveTool* NewTool = NewObject<UProfilingToolsPlusInteractiveTool>(SceneState.ToolManager);
...
UProfilingToolsPlusInteractiveToolProperties::UProfilingToolsPlusInteractiveToolProperties()
{
...
void UProfilingToolsPlusInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UProfilingToolsPlusInteractiveTool::Setup()
{
	...
	Properties = NewObject<UProfilingToolsPlusInteractiveToolProperties>(this, "Measurement");
...
void UProfilingToolsPlusInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UProfilingToolsPlusInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UProfilingToolsPlusInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UProfilingToolsPlusInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UProfilingToolsPlusInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UProfilingToolsPlusInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UProfilingToolsPlusInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UProfilingToolsPlusInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UProfilingToolsPlusInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
