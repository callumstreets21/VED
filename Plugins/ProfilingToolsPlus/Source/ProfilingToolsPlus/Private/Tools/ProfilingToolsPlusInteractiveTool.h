...
#include "ProfilingToolsPlusInteractiveTool.generated.h"


/**
 * Builder for UProfilingToolsPlusInteractiveTool
 */
UCLASS()
class PROFILINGTOOLSPLUS_API UProfilingToolsPlusInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UProfilingToolsPlusInteractiveTool
 */
UCLASS(Transient)
class PROFILINGTOOLSPLUS_API UProfilingToolsPlusInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UProfilingToolsPlusInteractiveToolProperties();
...
/**
 * UProfilingToolsPlusInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PROFILINGTOOLSPLUS_API UProfilingToolsPlusInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UProfilingToolsPlusInteractiveToolProperties> Properties;
