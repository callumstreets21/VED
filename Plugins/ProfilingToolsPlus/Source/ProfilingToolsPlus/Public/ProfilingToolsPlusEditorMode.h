...
#include "ProfilingToolsPlusEditorMode.generated.h"
 ...
 */
UCLASS()
class UProfilingToolsPlusEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ProfilingToolsPlusEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UProfilingToolsPlusEditorMode();
	virtual ~UProfilingToolsPlusEditorMode();
